...
def setup_logger(log_dir: Path, name: str = "cpr_gri_pipeline") -> logging.Logger:
    """Create a logger that writes to both a log file and stdout."""
    log_dir.mkdir(parents=True, exist_ok=True)
    log_path = log_dir / "cpr_gri_pipeline.log"
...
def array_stats(arr: np.ndarray, nodata: float = -9999.0, label: str = "") -> dict:
    """Descriptive statistics on a float array, ignoring nodata/NaN/Inf."""
